...
def run_cross_attention(df_train, df_val, df_test, run_id, res_dir, class_weights=None):
    ...
    train_ds = format_dataset(tokenize_cross_attention(prepare_dataset(df_train_ca, ["text", "hoax", "parent_text", "root_text"]), tokenizer), "cross_attention")
    val_ds   = format_dataset(tokenize_cross_attention(prepare_dataset(df_val_ca,   ["text", "hoax", "parent_text", "root_text"]), tokenizer), "cross_attention")
